...
public partial class FuOthersParts : System.Web.UI.Page
{
    ...
    public void PopulateUI(string fuID)
    {
        ...
        if (sqlTbl.Rows.Count > 0)
        {
            ...
            if (!string.IsNullOrEmpty(TblRow["CR"].ToString()))
                txtCR.Text = TblRow["CR"].ToString();
            else
                bindCR();
    ...
    public void PopulateIEUI(string ieID)
    {
        ...
        if (sqlTbl.Rows.Count > 0)
        {
            ...
            //txtTreatmentParagraph.Text = !string.IsNullOrEmpty(TblRow["TreatMentDetails"].ToString().Trim()) ? TblRow["TreatMentDetails"].ToString().Trim() : txtTreatmentParagraph.Text;
    ...
    private void bindCR()
    {
        ...
        string strBodypart = getBodyParts(Convert.ToInt64(Session["patientFUId"].ToString()), "fu");
