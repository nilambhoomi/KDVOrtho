    ...
    public static string Save(long ProcedureDetailID, long ProcedureMasterID, long _patientIEID, long? _patientFUID, string SubProcedureID, string BodyPart, long ProcedureID, string Medication, string Muscle, string Level, string Position, string date, string req, int BodyPartID, int IsFromNew, int? PatientProcedureID, Int16 IsConsidered, string Side)
    {
        ...
        switch (req)
        {
            ...
            case "Execute":
                ...
                Exe_Pos = Position;
                count = _bl.savePatientProcedureDetail(ProcedureDetailID, ProcedureMasterID, _patientIEID, _patientFUID, BodyPartID, ProcedureID, null, null, null, null, Executed, BodyPart, Medication, Muscle, Level, Req_Pos, Sch_Pos, Exe_Pos, FU_Pos, 0, IsFromNew, PatientProcedureID, req, IsConsidered, Side, SubProcedureID, null, bodyPartSide);
                break;
        }
        // return count;
        return count;
