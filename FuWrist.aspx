            ...
            <div class="col-lg-10" id="content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        ...
                        <button type="button" id="start_button1" onclick="startButton(event)">
                        ...
                        <table style="width: 40%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtFlexionRange" Style="display: none" ReadOnly="true" Width="50px" runat="server" Text="0-80"></asp:TextBox></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtExtensionRange" Style="display: none" ReadOnly="true" Width="50px" runat="server" Text="0-70"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtRadialdeviationRange" Style="display: none" ReadOnly="true" Width="50px" runat="server" Text="0-20"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtUlnarDeviationRange" Style="display: none" ReadOnly="true" Width="50px" runat="server" Text="0-30"></asp:TextBox></td>
                                </tr>
                            </tbody>
                        </table>
                        <br />
