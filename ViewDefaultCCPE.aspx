<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="ViewDefaultCCPE.aspx.cs" Inherits="ViewDefaultCCPE" %>
        ...
        <div class="page-content">
            ...
            <asp:UpdatePanel runat="server" ID="upMain">
                <ContentTemplate>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <asp:Button runat="server" ID="btnAdd" Text="Add New" CssClass="btn btn-primary" PostBackUrl="~/AddDefaultCCPE.aspx" />
                    ...
                    <asp:HiddenField runat="server" ID="hdLocation" />
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvPatientDetails" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" PagerStyle-CssClass="pager">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="CC" HeaderText="Chief Complain" />
                                        <asp:BoundField DataField="PE" HeaderText="Phycial Exam" />
                                       
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:HyperLink runat="server" CssClass="btn btn-link" ID="hlEdit" Target="_blank" NavigateUrl='<%# "~/AddDefaultCCPE.aspx?id="+Eval("Id") %>' Text="Edit"></asp:HyperLink>
    ...
    <script type="text/javascript">
        ...
        function SetAutoComplete() {
            $("#<%=txtSearch.ClientID %>").autocomplete({
                ...
                select: function (e, i) {
                    $("#<%=hdLocation.ClientID %>").val(i.item.val);
