...
public partial class ViewDefaultCCPE : System.Web.UI.Page
{
    ILog log = log4net.LogManager.GetLogger(typeof(ViewDefaultCCPE));
    ...
    public DataSet bindDetails(int pageIndex = 1, string sortorder = "asc", string columnname = "BodyPart")
    {
        DataSet lds = null;
        int totalrecords = 0;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            cnd = " where BodyPart like '%" + txtSearch.Text + "%' ";
        }
